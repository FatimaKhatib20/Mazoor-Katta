import 'package:edi_final/common_scr/main.dart';
import 'package:edi_final/employer/createJob.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:edi_final/employer/editProfile.dart';
import 'package:flutter/material.dart';


class emp_Sidebar extends StatelessWidget {
  @override
              ...
              children: [
                 Align(
                  ...
                  child: Padding(
                    ...
                    ListTile(
                      ...
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute( builder: (context) => const edit_Prof(),),);
                      },
                      title:
                ...
                Padding(
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute( builder: (context) => const create_Jobs()),);
                    },
                    title:
                    const Text("Create Job", style: TextStyle(fontSize: 25,fontFamily: 'Roboto')),
                    trailing: const Icon(
                      Icons.arrow_right_sharp,
                      color: Color(0xFF303030),
                      size: 40,
